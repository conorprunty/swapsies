          ...
          <div class="panel-body">
            <form action="register.php" method="post">
              <div class="input-group">
                ...
                <input name="username"class = "form-control" id ="input-default" type="text" placeholder= "Username" value="">
              </div>
              <br>
              <div class="input-group">
                ...
                <input name="password" class= "form-control" id ="input-default" type="password" placeholder="Password" value="">
              </div>
              <br>
              <div class="input-group">
                ...
                <input name="email" class = "form-control" id="input-default" type="text" placeholder="Email" value="">
              </div>
              <br>
              <br>
